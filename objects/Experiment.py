...
class Experiment:
    ...
    def __init__(self, target_columns, subset_columns, subset_columns_names, use_PRE_onlys, cols_to_exclude):
        """
        Args:
        ...
        self.target_columns, self.experiment_names, self.subset_columns, self.use_PRE_onlys = \
            self._generate_experiments(target_columns, subset_columns, subset_columns_names, use_PRE_onlys, cols_to_exclude)
    ...
    def _generate_experiments(
        ...
        for use_PRE_only in use_PRE_onlys:
            for target_col in target_columns:
                for subset_col, subset_col_name in zip(subset_columns, subset_columns_names):
                    experiment_name = f"{target_col}_{subset_col_name}_omit_{len(cols_to_exclude)}"
        ...
        return ret_target_columns, experiment_names, ret_subset_columns, ret_use_PRE_onlys        
    ...
    def __eq__(self, other):
        return self.target_columns == other.target_columns and self.subset_columns == other.subset_columns and \
            self.experiment_names == other.experiment_names and self.use_PRE_onlys == other.use_PRE_onlys